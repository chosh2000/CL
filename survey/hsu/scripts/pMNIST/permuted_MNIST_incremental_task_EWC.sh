GPUID=$1
# GPUID=0
OUTDIR=outputs/permuted_MNIST_incremental_task/EWC/$(date +'%m_%d_%Hh_%Mm')
REPEAT=1
mkdir -p $OUTDIR
...
# python -u iBatchLearn.py --gpuid $GPUID --repeat $REPEAT --optimizer Adam    --n_permutation 100 --no_class_remap --force_out_dim 0 --schedule 10 --batch_size 128 --model_name MLP1000 --agent_type regularization --agent_name MAS        --lr 0.0001 --reg_coef 0.01        | tee ${OUTDIR}/MAS.log
