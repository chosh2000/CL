...
python -u iBatchLearn.py --repeat $REPEAT --optimizer Adam    --n_permutation 20 --no_class_remap --force_out_dim 0 --schedule 10 --batch_size 128 --model_name MLP1000_drop --agent_type regularization --agent_name MAS     --lr 0.0001 --reg_coef 0.01        | tee ${OUTDIR}/MAS.log
