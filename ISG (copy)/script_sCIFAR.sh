...
python -u ISG_sCIFAR.py --use_gpu 1 --repeat $REPEAT --method MAS  --dataset sCIFAR100 --init_model 0 --out_dir $OUTDIR  --schedule 20 40  --apply_SIM 1 --rho 1 0.4 0.4 --reglambda 1 -random_drop 1 --revert_head 0| tee ${OUTDIR}/SIM_rho144_reg1_random.log
python -u ISG_sCIFAR.py --use_gpu 1 --repeat $REPEAT --method MAS  --dataset sCIFAR100 --init_model 0 --out_dir $OUTDIR  --schedule 20 40  --apply_SIM 1 --rho 1 0.4 0.4 --reglambda 1 --alpha 1 --xi 0.01 --revert_head 0| tee ${OUTDIR}/SIM_rho144_reg1_a1_xi001.log    
python -u ISG_sCIFAR.py --use_gpu 1 --repeat $REPEAT --method MAS  --dataset sCIFAR100 --init_model 0 --out_dir $OUTDIR  --schedule 20 40  --apply_SIM 1 --rho 1 0.4 0.4 --reglambda 1 --alpha 1 --xi 0.02 --revert_head 0| tee ${OUTDIR}/SIM_rho144_reg1_a1_xi002.log    
python -u ISG_sCIFAR.py --use_gpu 1 --repeat $REPEAT --method MAS  --dataset sCIFAR100 --init_model 0 --out_dir $OUTDIR  --schedule 20 40  --apply_SIM 1 --rho 1 0.4 0.4 --reglambda 1 --alpha 1 --xi 0.04 --revert_head 0| tee ${OUTDIR}/SIM_rho144_reg1_a1_xi004.log    
