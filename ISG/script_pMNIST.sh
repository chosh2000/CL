...
python -u SIM.py --use_gpu 1 --repeat $REPEAT --out_dir $OUTDIR  --dataset pMNIST   --method MAS  --model_type MLP  --mlp_size 2000 --num_task 10 --print_freq 200 --schedule 10 10 --apply_SIM 1 --random_drop 1 --rho 0.2 0.2  --lr 0.0001 --reglambda 0.01  --alpha 1 --xi 0.01 --revert_head 0 --finetune_epoch 10   | tee ${OUTDIR}/SIM_rho_22_random.log
