...
python -u SIM.py --use_gpu 0 --repeat $REPEAT --out_dir $OUTDIR  --dataset pMNIST  --method MAS  --model_type MLP  --mlp_size 100 --num_task 10 --print_freq 200 --schedule 10 --apply_SIM 1 --random_drop 1 --rho 0.5 0.5  --lr 0.0001 --reglambda 0.01  --alpha 1 --xi 0.01 --revert_head 0    | tee ${OUTDIR}/SIM_rho_5_5_random.log
python -u SIM.py --use_gpu 0 --repeat $REPEAT --out_dir $OUTDIR  --dataset pMNIST  --method MAS  --model_type MLP  --mlp_size 100 --num_task 10 --print_freq 200 --schedule 10 --apply_SIM 1 --random_drop 0 --rho 0.5 0.5  --lr 0.0001 --reglambda 0.01  --alpha 1 --xi 0.01 --revert_head 1    | tee ${OUTDIR}/SIM_rho_5_5_revert1.log
python -u SIM.py --use_gpu 0 --repeat $REPEAT --out_dir $OUTDIR  --dataset pMNIST  --method MAS  --model_type MLP  --mlp_size 100 --num_task 10 --print_freq 200 --schedule 10 --apply_SIM 1 --random_drop 0 --rho 0.5 0.5  --lr 0.0001 --reglambda 0.01  --alpha 1 --xi 0.01 --revert_head 0    | tee ${OUTDIR}/SIM_rho_5_5_revert0.log
