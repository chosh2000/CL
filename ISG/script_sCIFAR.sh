...
python -u SIM.py --use_gpu 1 --repeat $REPEAT --out_dir $OUTDIR  --dataset sCIFAR100  --method MAS  --model_type CNN --cnn_size 2 --init_model 0  --schedule 20 40  --apply_SIM 1 --rho 1 1 1 0.4 0.4   --reglambda 1 --alpha 5 --xi 0.01 --revert_head 0| tee ${OUTDIR}/SIM_rho11144_size2_reg1_a5_xi001.log    
...
=======
python -u SIM.py --use_gpu 1 --repeat $REPEAT --out_dir $OUTDIR  --dataset sCIFAR100  --method MAS  --model_type CNN --cnn_size 4 --init_model 1  --schedule 20 40  --apply_SIM 0 --rho 1 1 1 1 1     --reglambda 0 	--random_drop 0 --revert_head 1| tee ${OUTDIR}/ANN_rho11111_size4_reg0.log
python -u SIM.py --use_gpu 1 --repeat $REPEAT --out_dir $OUTDIR  --dataset sCIFAR100  --method MAS  --model_type CNN --cnn_size 4 --init_model 0  --schedule 20 40  --apply_SIM 0 --rho 1 1 1 1 1     --reglambda 1 	--random_drop 0 --revert_head 1| tee ${OUTDIR}/MAS_rho11111_size4_reg1.log
python -u SIM.py --use_gpu 1 --repeat $REPEAT --out_dir $OUTDIR  --dataset sCIFAR100  --method SI   --model_type CNN --cnn_size 4 --init_model 0  --schedule 20 40  --apply_SIM 0 --rho 1 1 1 1 1     --reglambda 80 	--random_drop 0 --revert_head 1| tee ${OUTDIR}/SI__rho11111_size4_reg80.log
python -u SIM.py --use_gpu 1 --repeat $REPEAT --out_dir $OUTDIR  --dataset sCIFAR100  --method EWC  --model_type CNN --cnn_size 4 --init_model 0  --schedule 20 40  --apply_SIM 0 --rho 1 1 1 1 1     --reglambda 1000 	--random_drop 0 --revert_head 1| tee ${OUTDIR}/EWC_rho11111_size4_reg1000.log
...
python -u SIM.py --use_gpu 1 --repeat $REPEAT --out_dir $OUTDIR  --dataset sCIFAR100  --method MAS  --model_type CNN --cnn_size 4 --init_model 0  --schedule 20 40  --apply_SIM 1 --rho 1 1 1 0.2 0.2   --reglambda 1 --random_drop 1     --revert_head 0| tee ${OUTDIR}/SIM_rho11122_size4_reg1_random.log    
# python -u SIM.py --use_gpu 1 --repeat $REPEAT --out_dir $OUTDIR  --dataset sCIFAR100  --method MAS  --model_type CNN --cnn_size 2 --init_model 0  --schedule 20 40  --apply_SIM 1 --rho 1 1 0.4 1 0.4   --reglambda 1 --alpha 5 --xi 0.01 --revert_head 0 --random_drop 1| tee ${OUTDIR}/SIM_rho11414_size2_reg1_random.log    
>>>>>>> f18b3829724f918e79873024d051cc78ca009496
