...
python -u ISG_sCIFAR.py --use_gpu 1 --repeat $REPEAT --method MAS  --dataset sCIFAR100 --init_model 0 --out_dir $OUTDIR  --schedule 20 40  --apply_SIM 1 --rho 1 0.4 0.4 --reglambda 0.1 --alpha 0| tee ${OUTDIR}/SIM_rho144_reg1_a0_dropout.log    
python -u ISG_sCIFAR.py --use_gpu 1 --repeat $REPEAT --method MAS  --dataset sCIFAR100 --init_model 0 --out_dir $OUTDIR  --schedule 20 40  --apply_SIM 0 --rho 1 1 1     --reglambda 0.1   | tee ${OUTDIR}/MAS_reg1_dropout.log    
python -u ISG_sCIFAR.py --use_gpu 1 --repeat $REPEAT --method EWC  --dataset sCIFAR100 --init_model 0 --out_dir $OUTDIR  --schedule 20 40  --apply_SIM 0 --rho 1 1 1     --reglambda 100   | tee ${OUTDIR}/EWC_reg1_dropout.log    
python -u ISG_sCIFAR.py --use_gpu 1 --repeat $REPEAT --method SI   --dataset sCIFAR100 --init_model 0 --out_dir $OUTDIR  --schedule 20 40  --apply_SIM 0 --rho 1 1 1     --reglambda 10    | tee ${OUTDIR}/SI_reg1_dropout.log    
