...
# python -u SIM.py --use_gpu 1 --repeat $REPEAT --out_dir $OUTDIR  --dataset sCIFAR100  --method MAS  --model_type CNN  --init_model 1  --schedule 20 40  --apply_SIM 1 --rho 1 1 1 0.4 0.4 --reglambda 1 --random_drop 1 --revert_head 0| tee ${OUTDIR}/SIM_rho11144_reg1_random.log
...
python -u SIM.py --use_gpu 1 --repeat $REPEAT --out_dir $OUTDIR  --dataset sCIFAR100  --method MAS  --model_type CNN  --init_model 0  --schedule 20 40  --apply_SIM 1 --rho 1 1 0.8 0.8 0.8 --reglambda 1 --alpha 5 --xi 0.01 --revert_head 0| tee ${OUTDIR}/SIM_rho11888_reg1_a5_xi001.log 
python -u SIM.py --use_gpu 1 --repeat $REPEAT --out_dir $OUTDIR  --dataset sCIFAR100  --method MAS  --model_type CNN  --init_model 0  --schedule 20 40  --apply_SIM 1 --rho 1 1 0.7 0.7 0.7 --reglambda 1 --alpha 5 --xi 0.01 --revert_head 0| tee ${OUTDIR}/SIM_rho11777_reg1_a5_xi001.log    
python -u SIM.py --use_gpu 1 --repeat $REPEAT --out_dir $OUTDIR  --dataset sCIFAR100  --method MAS  --model_type CNN  --init_model 0  --schedule 20 40  --apply_SIM 1 --rho 1 1 0.6 0.6 0.6 --reglambda 1 --alpha 5 --xi 0.01 --revert_head 0| tee ${OUTDIR}/SIM_rho11666_reg1_a5_xi001.log 
python -u SIM.py --use_gpu 1 --repeat $REPEAT --out_dir $OUTDIR  --dataset sCIFAR100  --method MAS  --model_type CNN  --init_model 0  --schedule 20 40  --apply_SIM 1 --rho 1 1 0.5 0.5 0.5 --reglambda 1 --alpha 5 --xi 0.01 --revert_head 0| tee ${OUTDIR}/SIM_rho11555_reg1_a5_xi001.log    
python -u SIM.py --use_gpu 1 --repeat $REPEAT --out_dir $OUTDIR  --dataset sCIFAR100  --method MAS  --model_type CNN  --init_model 0  --schedule 20 40  --apply_SIM 1 --rho 1 1 0.4 0.4 0.4 --reglambda 1 --alpha 5 --xi 0.01 --revert_head 0| tee ${OUTDIR}/SIM_rho11444_reg1_a5_xi001.log    
