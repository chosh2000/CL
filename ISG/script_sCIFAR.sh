...
# python -u SIM.py --use_gpu 1 --repeat $REPEAT --out_dir $OUTDIR  --dataset sCIFAR100  --method MAS  --model_type CNN --cnn_size 5 --init_model 0  --schedule 20 40  --apply_SIM 1 --rho 1 1 1 0.4 0.4   --reglambda 1    --random_drop 1 --revert_head 1| tee ${OUTDIR}/SIM_rho11144_random.log    
...
python -u SIM.py --use_gpu 1 --repeat $REPEAT --out_dir $OUTDIR  --dataset sCIFAR100  --method EWC  --model_type CNN --cnn_size 1 --init_model 0  --schedule 20 40  --apply_SIM 0 --rho 1 1 1 1 1       --reglambda 180 --random_drop 0 --revert_head     1| tee ${OUTDIR}/EWC_rho11111_size1_reg180.log
