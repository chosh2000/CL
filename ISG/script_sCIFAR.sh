...
python -u SIM.py --use_gpu 1 --repeat $REPEAT --init_model 1 --out_dir $OUTDIR  --dataset sCIFAR100  --method MAS  --model_type CNN  --init_model 0  --schedule 20 40  --apply_SIM 1 --rho 1 1 1 0.4 0.4 --reglambda 1 --random_drop 1 --revert_head 0| tee ${OUTDIR}/SIM_rho11144_reg1_random.log
