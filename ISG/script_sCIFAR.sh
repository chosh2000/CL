...
# python -u SIM.py --use_gpu 1 --repeat $REPEAT --out_dir $OUTDIR  --dataset sCIFAR100  --method MAS  --model_type CNN --cnn_size 2 --init_model 0  --schedule 20 40  --apply_SIM 1 --rho 1 1 0.7 0.7 0.7 --reglambda 1 --alpha 5 --xi 0.01 --revert_head 0| tee ${OUTDIR}/SIM_rho11777_size2_reg1_a5_xi001.log    
...
# python -u SIM.py --use_gpu 1 --repeat $REPEAT --out_dir $OUTDIR  --dataset sCIFAR100  --method MAS  --model_type CNN --cnn_size 2 --init_model 0  --schedule 20 40  --apply_SIM 1 --rho 1 1 0.5 0.5 0.5 --reglambda 1 --alpha 5 --xi 0.01 --revert_head 0| tee ${OUTDIR}/SIM_rho11555_size2_reg1_a5_xi001.log    
