...
python -u SIM.py --use_gpu 1 --repeat $REPEAT --out_dir $OUTDIR  --dataset sCIFAR100  --method MAS  --model_type CNN  --init_model 0  --schedule 1  --apply_SIM 1 --rho 1 0.4 0.4 --reglambda 1 --random_drop 1 --revert_head 0| tee ${OUTDIR}/SIM_rho144_reg1_random.log
python -u SIM.py --use_gpu 1 --repeat $REPEAT --out_dir $OUTDIR  --dataset sCIFAR100  --method MAS  --model_type CNN  --init_model 0  --schedule 1  --apply_SIM 0 --rho 1 1 1     --reglambda 0 --random_drop 0 --revert_head 1| tee ${OUTDIR}/ANN_rho111_reg0.log
