...
python -u ISG_sCIFAR.py --use_gpu 1 --repeat $REPEAT --method SI  --dataset sCIFAR100 --init_model 0 --out_dir $OUTDIR  --schedule 5 8  --apply_SIM 0 --rho 1 1 1 --reglambda 1 | tee ${OUTDIR}/EWC_reg1_dropout.log    
