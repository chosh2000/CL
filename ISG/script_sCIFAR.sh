...
python -u ISG_sCIFAR.py --use_gpu 1 --repeat $REPEAT --method MAS  --dataset sCIFAR100 --init_model 0 --out_dir $OUTDIR  --schedule 20 40  --apply_SIM 1 --rho 1 0.4 0.4 --reglambda 1 --alpha 1 --xi 0.1 --revert_head 0| tee ${OUTDIR}/SIM_rho144_reg01_a1_xi1.log    
