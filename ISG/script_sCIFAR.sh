...
python -u ISG_sCIFAR.py --use_gpu True --repeat $REPEAT --out_dir $OUTDIR  --schedule 60 100 --rho 0.5 0.5 0.5 --reglambda 0.1 --alpha 0.5    | tee ${OUTDIR}/SIM_rho555_reg01.log
